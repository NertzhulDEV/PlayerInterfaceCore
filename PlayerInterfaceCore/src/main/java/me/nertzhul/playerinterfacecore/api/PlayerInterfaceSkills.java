...
public class PlayerInterfaceSkills {
    public Collection<Skill.SkillInfo> getPlayerSkills(Player player) {
        return PlayerData.get((OfflinePlayer) player).getProfess().getSkills();
    }

    public List<Skill.SkillInfo> getPlayerBoundSkills(Player player) {
        return PlayerData.get((OfflinePlayer) player).getBoundSkills();
    }

    public Skill.SkillInfo getSkill(Player player, String skillName) {
